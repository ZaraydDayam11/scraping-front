        ...
        @if ($voucher['status'] == 'PA')
            <div class="container_01">
                <div class="header">
                    ...
                    <img class="header_img" src="{{ $message->embed($imagePathLogo) }}" alt="Icono SCRAPING Perú">
                </div>
        ...
        @else
            <div style="font-family: Poppins">
                ...
                <table role="header" width="100%">
                    <tr>
                        <td bgcolor="#003BB3" style="padding: 40px 64px; font-size: 14px;">
                            <img class="header_img" src="{{ $message->embed($imagePathLogo) }}"
                                alt="Icono SCRAPINGPerú">
                        </td>
                    </tr>
                </table>
                ...
                <table role="content" style="padding: 80px 64px; color: #363740;">
                    ...
                    <tr>
                        <td style="padding-bottom: 24px;">
                            ...
                            <ol style="margin-top: 16px;">
                                <li>Ingresa a la página de SCRAPINGPERÚ.</li>
                    ...
                    <tr>
                        <td style="padding-bottom: 24px;">
                            Para hacer la confirmación, ingrese a la pagina SCRAPINGPERÚ para realizar la confirmación.
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="line-height: 40px">
                            <span>Thanks</span> <br />
                            <span style="font-weight: 600">The SCRAPINGPERÚ</span>
                        </td>
                    </tr>
